	...
	display(): void {
		...
		new Setting(containerEl)
			...
			.addDropdown(dropdown =>
				dropdown
					.addOptions({
						[ColoredTagsPaletteType.ADAPTIVE_SOFT]: '🌸 Adaptive soft',
						[ColoredTagsPaletteType.ADAPTIVE_BRIGHT]: '🌺 Adaptive bright',
		...
		new Setting(containerEl)
			...
			.addSlider(slider =>
				slider.setLimits(0, this.plugin.palettes.light.length - 1, 1)
		...
		new Setting(containerEl)
			...
			.addToggle(toggle =>
				toggle.setValue(this.showAccessibility).onChange(async (value) => {
		...
		if (this.showAccessibility) {
			new Setting(containerEl)
				...
				.addToggle(toggle =>
					toggle.setValue(this.plugin.settings.accessibility.highTextContrast).onChange(async (value) => {
		...
		if (this.showExperimental) {
			new Setting(containerEl)
				...
				.addToggle(toggle =>
					toggle.setValue(this.plugin.settings.mixColors).onChange(async (value) => {
			...
			new Setting(containerEl)
				...
				.addToggle(toggle =>
					toggle.setValue(this.plugin.settings.transition).onChange(async (value) => {
